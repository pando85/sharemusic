...
from sharemusic.apps.core.models import User, Playlist
from sharemusic.apps.api.v1.serializers import  PlaylistDetailSerializer, PlaylistListSerializer
from sharemusic.apps.api.v1.tests.views import UNAUTHENTICATED_RESPONSE
